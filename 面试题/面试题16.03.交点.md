...
> 思路描述：这个题目数学上挺好解的，一个直线经过(x1,y1)、(x2,y2)，那么这条直线的方程为$y = k x+b,k=\frac{y_2-y_1}{x_2-x_1},b=y_1-kx_1=y_2-kx_2$
>
> 那么两条直线如果斜率相同但是b不同那么不会相交，如果b相同重叠
>
> 如果两条直线斜率不同，可以算出来交点，然后判断一下交点是不是在线段上即可。
>
> 其中需要考虑到斜率不存在的情况。
